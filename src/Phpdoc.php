...
class Phpdoc extends AbstractGenerator
{
    ...
    {
        if (!file_exists(dirname(__DIR__) . '/vendor/bin/phpdoc.php')) {
            $this->logger->debug('Skipped, vendor/bin/phpdoc.php not found.');
            return;
        }
    ...
    {
        $this->logger->debug('Generate docs using phpdoc');
